    ...
    return (
      <div className="p-4 md:p-8">
        <div className="grid grid-cols-1 md:grid-cols-[1fr_1.5fr] gap-8">
          <div className="relative flex flex-col-reverse md:flex-row gap-4 overflow-hidden rounded-lg">
            {/* Render all images as thumbnails */}
            <div className="flex gap-4 md:flex-col overflow-y-auto scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-gray-300">
